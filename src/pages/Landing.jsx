        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              חוויה מוזיקלית ייחודית, שירות VIP, ואווירה בלתי נשכחת<br />
              הצטרפו אלינו לערב שלא תשכחו! 🎤✨
            </p>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              מועדון אפריון נוסד מתוך אהבה עמוקה למוזיקה ולחוויות חברתיות ייחודיות. 
              אנחנו מאמינים שכל אחד יכול להיות כוכב, ושכל ערב יכול להפוך לבלתי נשכח.
            </p>
            <p style={{
              fontSize: "1.2rem",
              color: "#e2e8f0",
              ...
              עם מערכת קריוקי מתקדמת, שירות VIP ואווירה מיוחדת, אנחנו יוצרים חוויות 
              שמשאירות חותם. הצטרפו למשפחה שלנו ותהיו חלק מהקסם! ✨
            </p>
          </div>
        </div>
      </section>
