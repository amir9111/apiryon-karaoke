...
export default function EventProducer() {
  ...
  const [invitationType, setInvitationType] = useState("regular"); // regular or story
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Step 1: AI מנתח את הטקסט ויוצר תוכן שיווקי
...
החזר JSON במבנה הבא:
{
  ...
  const dimensions = invitationType === "story" 
